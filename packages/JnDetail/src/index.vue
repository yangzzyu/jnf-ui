 ...
 * @LastEditTime: 2023-09-28 09:43:35
 * @FilePath: \jnf-ui-master\packages\JnDetail\src\index.vue
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
-->
<template>
  <el-descriptions class="jn_detail" size="small" v-bind="$attrs" :column="descColumn">
